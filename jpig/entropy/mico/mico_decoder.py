...
from jpig.entropy import CabacDecoder, ExponentialSmoothingPM
...
class MicoDecoder:
    def __init__(self):
        ...
        self.flags_probability_model = ExponentialSmoothingPM()
    ...
    def _decode_flag(self):
        flag = self.cabac.decode_bit(model=self.flags_probability_model)
        if flag:
            return "C"
        else:
            return "Z"
